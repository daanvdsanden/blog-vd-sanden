...
BLOG_AUTHOR = "Daan van der Sanden"  # (translatable)
BLOG_TITLE = "blog-vd-sanden"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://blog.vd-sanden.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://blog.vd-sanden.net/"
BLOG_EMAIL = "daan@vd-sanden.nl"
BLOG_DESCRIPTION = "This blog is to wite down some thought on network automation"  # (translatable)
